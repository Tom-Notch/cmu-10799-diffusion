...
class BaseMethod(nn.Module, ABC):
    ...
    @abstractmethod
    def compute_loss(self, x: torch.Tensor, **kwargs) -> Tuple[torch.Tensor, Dict[str, float]]:
        """
    ...
    @abstractmethod
    def sample(self, batch_size: int, image_shape: Tuple[int, int, int], **kwargs) -> torch.Tensor:
        """
